...
var array2 = [-1, 7, 5, 11, 12, 2, 14, 3, 10, 4, 6];
var q1 = partition(array2, 0, array2.length-1);
println("Array after partitioning: " + array2);
Program.assertEqual(q1, 5);
Program.assertEqual(array2, [-1, 5, 2, 3, 4, 6, 14, 11, 10, 12, 7]);
